...
function onFileSelected(event) {
	...
	const predictionEl = document.getElementById('prediction')
		...
		reader.addEventListener("loadend", function() {             
				...
				fetch('https://hf.space/embed/Asteriks/Zebra_crossing/+/api/predict', {
method: "POST",
...
headers: { "Content-Type": "application/json" } })
				...
				.then(function(json_response) {
					...
					// Get the confidences for zebra and zebra_crossing
					// firstLabel and secondLabel are zebra and zebra_crossing
					// the order changes depending on the category predicted,
					// that's why the variable names are not fixed to zebraLabel/zebra_crossingLabel
...
//https://hf.space/embed/jph00/testing/api
